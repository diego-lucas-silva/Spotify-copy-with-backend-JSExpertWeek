...
describe('#Service - test suite for core processing', () => {
  ...
  test('Must return a type and name of a passed file #createFileStream', () => {
  ...
  test('Should return an object containig a name an type #getFileInfo', async () => {
  ...
  test('Should return a fileStream #getFileStream', async () => {
    const currentReadable = TestUtil.generateReadableStream(['abc'])
    const currentSong = `mySong.mp3`
